...
STAKING_OPTIMIZER_LOGIC = "0xe73e74Fab5e1cfE7545421D7DC63da42fC62b0d3"
...
def deploy_vaults_and_strategies(
    ...
    assert params.performanceFeeStrategist == 0

    # Initialize proxy
    strat_proxy.initialize(*args, {"from": dev})

    # A few checks to confirm initialization
    assert strat_proxy.stableSwapSlippageTolerance() == 500
    assert strat_proxy.withdrawalFee() == 10

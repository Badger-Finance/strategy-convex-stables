...
- Basic Solidity Smart Contract for creating your own Badger Strategy ([`contracts/StrategyConvexStables.sol`](contracts/StrategyConvexStables.sol))
...
2. Write the Strategy Code in StrategyConvexStables.sol
...
[`contracts/StrategyConvexStables.sol`](contracts/StrategyConvexStables.sol) is where you implement your own logic for your strategy. In particular:

- Customize the `initialize` Method
- Set a name in `StrategyConvexStables.getName()`
- Set a version in `StrategyConvexStables.version()`
- Write a way to calculate the want invested in `StrategyConvexStables.balanceOfPool()`
- Write a method that returns true if the Strategy should be tended in `StrategyConvexStables.isTendable()`
- Set a version in `StrategyConvexStables.version()`
